...
`
	...
	return (
		<div>
			...
			<p>フォームコントロールには入力値の種類によって入力タイプに応じたUIを表示できる。入力するときに本来許可されない種類の入力値が入力出来たり、数値の入力が行いやすくなるため、適切な入力タイプを選ぶ必要がある。</p>
			...
			<p>入力値が限定された値のうちの一つであるにもかかわらず，自由入力形式のフォームコントロールが使われている場合がある．例えば以下のような例がある．</p>
