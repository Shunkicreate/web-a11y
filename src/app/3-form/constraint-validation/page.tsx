	...
	return (
		<div>
			...
			<p>
				...
				また修正方法を理解しやすくする必要があります。 エラーが起きないフォーム設計や多様な入力値の許容も重要です。
			...
			<p>
				...
				ユーザーが入力に時間がかかる原因となり、効率性を低下させることがあります。 適切な制約設定が望ましいです。
			</p>
			<h4>解決策</h4>
			<ul>
				<li>入力の制約を最小限にする</li>
			...
			<ul>
				...
				<p>
					・HTML標準の制約検証を利用することを検討する<br></br>
					・エラーをテキストで表現し、エラーの発生箇所の近くに配置する
				</p>
				<li>
			...
			<ul>
				...
				<p>
					...
					・エラーメッセージをフォームコントロールに関連付ける（エラーメッセージをlabel要素に含めるか、ariadescribedby属性で関連付ける）
					<br></br>
