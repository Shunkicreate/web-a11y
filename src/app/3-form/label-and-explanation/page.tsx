...
const Index = () => {
	...
	const labelafterlaceHolder = (
		<div>
			<label htmlFor='userform'>ユーザ名</label>
			<br />
	...
	return (
		<div>
			...
			<h2 style={{ marginTop: 80 }}> 事例2. 説明がフォームの後に配置されている</h2>
			...
			<h2 style={{ marginTop: 40 }}>事例3. フォームコントロールにラベルと説明が関連付けられてない</h2>
			<p>スクリーンリーダーはフォームコントロールに関連付けられた情報を読み上げる</p>

			<h2 style={{ marginTop: 40 }}> 事例4. 入力必須の説明をしていない</h2>
			...
			<h2>事例1. フォームコントローラーにラベルと説明を関連付ける</h2>
			<ul>
				<li>
			...
			<h2 style={{ marginTop: 40 }}>事例2. フォームコントロールに不可視のラベルをつける</h2>
			<ul>
				<li>
			...
			<h2 style={{ marginTop: 40 }}>事例3.グループにラベルと説明を関連づける</h2>
