...
const Page = () => {
	...
	return (
		<>
			<div style={{ width: "100%", backgroundColor: "#f6bd60bb", color: "black" }}>
				<h1>ヘッダー</h1>
			</div>
			<div style={{ width: "100%", display: "flex", color: "black" }}>
				<div style={{ width: "50%", backgroundColor: "#ff99c8bb" }}>
					<h2>contains1</h2>
					<p>
				...
				<div style={{ width: "50%", backgroundColor: "#fcf6bdbb" }}>
					<h2>contains2</h2>
					<p>
			...
			<div style={{ width: "100%", display: "flex", color: "black" }}>
				<div style={{ width: "33.3%", backgroundColor: "#d0f4debb" }}>
					<h2>contains3</h2>
					<p>
				...
				<div style={{ width: "33.3%", backgroundColor: "#a9def9bb" }}>
					<h2>contains4</h2>
					<p>
				...
				<div style={{ width: "33.3%", backgroundColor: "#e4c1f9bb" }}>
					<h2>contains5</h2>
					<p>
